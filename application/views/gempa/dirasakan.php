...
<body class="hold-transition sidebar-mini">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">Peta Titik Gempa Dirasakan</div>
                                <div class="card-body p-0">
                                    <div id="mapGempaDirasakan" style="width: 100%; height: 400px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function earthquakeMap(earthquake, success) {
            var mymap = L.map("mapGempaDirasakan").setView([-1.263325, 118.606436], 4);
            ...
            if (success == true) {
                earthquake.forEach(function(item) {
                    ...
                    L.circle([latitude, longitude], {
                        ...
                        .addTo(mymap).bindTooltip(dateTime + " / " + magnitude + " SR");
                });
            }
